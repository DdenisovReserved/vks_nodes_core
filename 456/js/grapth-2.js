...
//            ------------------------------------------------
            ...
            $.post("?route=ReservedVks/create", obj, function (e) {
                if (typeof editLogic == 'undefined') {
                    $("<div class='cancel-time-container'><div class='alert alert-success text-center'><h4><span class='glyphicon glyphicon-exclamation-sign text-info'></span> Выбранное время зарезервировано. Резерв времени будет аннулирован через <span id='timer' data-timer='15:00'>15:00</span></h4></div><div class=' col-lg-6'><button type='button' class='btn btn-default btn-lg reset-reserved pull-right' data-reserved_vks='" + e + "'><span class='glyphicon glyphicon-remove-circle text-danger'></span> Отменить резерв и выбрать другое время</button></div><div class='col-lg-6'><button type='button' class='btn btn-info btn-lg' id='batch-add' data-reserved_vks='" + e + "'><span class='glyphicon glyphicon-calendar'></span> Добавить еще время (сделать переодической)</button></div></div>").appendTo(".here-render-timeLine");
                } else {
                    $("<div class='cancel-time-container'><div class='alert alert-success text-center'><h4><span class='glyphicon glyphicon-exclamation-sign text-info'></span> Выбранное время зарезервировано. Резерв времени будет аннулирован через <span id='timer' data-timer='15:00'>15:00</span></h4></div><div class='col-lg-12 text-center'><button type='button' class='btn btn-default btn-lg reset-reserved' data-reserved_vks='" + e + "'><span class='glyphicon glyphicon-remove-circle text-danger'></span> Отменить резерв и выбрать другое время</button></div></div>").appendTo(".here-render-timeLine");
                }
