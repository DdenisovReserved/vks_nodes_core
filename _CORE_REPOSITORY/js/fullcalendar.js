    ...
    $.extend(TimeGrid.prototype, {
        ...
        slatRowHtml: function () {
            ...
            while (slotTime < this.maxTime) {
                ...
                if (slotDate.toDate() >= new Date()) {
                    html +=
                        '<tr ' + (!minutes ? 'class="timerow"' : 'class="timerow fc-minor"') + ' data-datetime="'+htmlEscape(calendar.formatDate(slotDate, "DD.MM.YYYY HH:mm"))+'">' +
                        (!isRTL ? axisHtml : '') +
                    ...
                    html +=
                        '<tr ' + (!minutes ? 'class=""' : 'class=" fc-minor"') + '>' +
                        (!isRTL ? axisHtml : '') +
                        '<td class="' + view.widgetContentClass + '"/>' +
                        (isRTL ? axisHtml : '') +
                        "</tr>";
